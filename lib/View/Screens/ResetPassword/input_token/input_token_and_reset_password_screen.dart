...
class InputTokenAndResetPasswordScreen extends StatefulWidget {
  final VoidCallback toggle;

  const InputTokenAndResetPasswordScreen({super.key, required this.toggle});

  @override
  State<InputTokenAndResetPasswordScreen> createState() =>
      _InputTokenAndResetPasswordScreenState();
}

class _InputTokenAndResetPasswordScreenState
    extends State<InputTokenAndResetPasswordScreen>
    with
        SingleTickerProviderStateMixin<InputTokenAndResetPasswordScreen>,
        DisposeBagMixin {
